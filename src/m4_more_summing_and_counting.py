...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 2
    answer = count_cosines_from(6, 10, 0.4)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_cosines_from(9, 13, 0.32)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(12, 16, 0.54)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(20, 25, 0.7)
