...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected =-0.39532517882
    answer=sum_more_cosines(-2,4)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected =0.20859857518
    answer =sum_more_cosines(3,8)
...
def run_test_count_sines_from():
    ...
    # Test 4:
    expected = 5
    answer = count_sines_from(24, 30)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_sines_from(101, 106)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_sines_from(18,22)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
